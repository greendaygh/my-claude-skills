...
>    - **완전성**: 논문에서 확인되는 모든 UO 간 sample/data/control_signal 흐름을 빠짐없이 기록할 것. 모든 UO 쌍을 검토하여 관계가 있는 것은 모두 포함.
>
...
>    - **완전성**: workflows 배열에 있는 모든 워크플로 쌍 간의 관계를 검토하고, 논문에서 관계가 확인되는 모든 쌍에 대해 항목을 생성할 것.
>
>    **workflows 규칙**:
